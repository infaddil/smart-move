...
5. **ETA Interpretation:** If a bus's ETA is negative, it means bus has passed by the destination asked by user. Do not recommend the bus stop if eta is negative. if negative, pls consider other transportation mode. if 0, it means, its approaching to the destination
